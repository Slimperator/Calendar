function calendargwt(){
  ...
  calendargwt.__sendStats = sendStats;
  calendargwt.__moduleName = $intern_4;
  calendargwt.__errFn = null;
  calendargwt.__moduleBase = $intern_6;
  calendargwt.__softPermutationId = $intern_7;
  calendargwt.__computePropValue = null;
  calendargwt.__getPropMap = null;
  calendargwt.__installRunAsyncCode = function(){
  }
  ;
  calendargwt.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  calendargwt.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  calendargwt.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  calendargwt.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[calendargwt.__softPermutationId];
  ...
  function installScript(filename){
    ...
    function installCode(code_0){
      ...
      script.src = code_0;
      if (calendargwt.__errFn) {
        script.onerror = function(){
          calendargwt.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  calendargwt.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  calendargwt.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    calendargwt.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return calendargwt.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    calendargwt.__getPropMap = function(){
      var result = {};
    ...
    ;
    calendargwt.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = calendargwt.__getPropMap;
    ...
    calendargwt.__softPermutationId = softPermutationId;
  ...
  processMetas();
  calendargwt.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = calendargwt.__moduleBase;
...
calendargwt.succeeded = calendargwt();
